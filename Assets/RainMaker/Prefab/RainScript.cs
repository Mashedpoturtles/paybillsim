...
private void UpdateRain ( )
    ...
    if ( RainFallParticleSystem != null )
        {
        RainFallParticleSystem.transform.position = RainCam.transform.position;
        RainFallParticleSystem.transform.Translate ( 0.0f, RainHeight, RainForwardOffset );
        RainFallParticleSystem.transform.rotation = Quaternion.Euler ( 0.0f, RainCam.transform.rotation.eulerAngles.y, 0.0f );
        }
    if ( RainMistParticleSystem != null )
        {
        Vector3 pos = RainCam.transform.position;
