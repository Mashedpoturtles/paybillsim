...
namespace DigitalRuby.RainMaker
{
    public class RainScript2D : BaseRainScript
    {
        ...
        private void TransformParticleSystem(ParticleSystem p, float initialStartSpeed, float initialStartSize)
        {
            ...
            p.transform.position = new Vector3(RainCam.transform.position.x, visibleBounds.max.y + yOffset, p.transform.position.z);
        ...
        protected override void Update()
        {
            ...
            cameraMultiplier = (RainCam.orthographicSize * 0.25f);
